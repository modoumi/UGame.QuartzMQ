...
namespace UGame.Quartz.Repository
{
	...
	/// <summary>
	/// 
	/// 【表 sr_oper_activity_bonus_day 的实体类】
	/// </summary>
	[DataContract]
	public class Sr_oper_activity_bonus_dayEO : IRowMapper<Sr_oper_activity_bonus_dayEO>
	{
		/// <summary>
		/// 构造函数 
		/// </summary>
		public Sr_oper_activity_bonus_dayEO()
		{
			this.Amount = 0;
		}
		#region 主键原始值 & 主键集合
		...
		/// <return>实体对象</return>
		public Sr_oper_activity_bonus_dayEO MapRow(IDataReader reader)
		{
		...
		/// <param name = "reader">只进结果集流</param>
		/// <return>实体对象</return>
		public static Sr_oper_activity_bonus_dayEO MapDataReader(IDataReader reader)
		{
		    Sr_oper_activity_bonus_dayEO ret = new Sr_oper_activity_bonus_dayEO();
	...
	/// <summary>
	/// 
	/// 【表 sr_oper_activity_bonus_day 的操作类】
	/// </summary>
	public class Sr_oper_activity_bonus_dayMO : MySqlTableMO<Sr_oper_activity_bonus_dayEO>
	{
		/// <summary>
		/// 表名
		/// </summary>
	    public override string TableName { get; set; } = "`sr_oper_activity_bonus_day`";
		...
		public Sr_oper_activity_bonus_dayMO(MySqlDatabase database) : base(database) { }
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name = "connectionStringName">配置文件.config中定义的连接字符串名称</param>
		public Sr_oper_activity_bonus_dayMO(string connectionStringName = null) : base(connectionStringName) { }
	    /// <summary>
	    /// 构造函数
	    /// </summary>
	    /// <param name="connectionString">数据库连接字符串，如server=192.168.1.1;database=testdb;uid=root;pwd=root</param>
	    /// <param name="commandTimeout">CommandTimeout时间</param>
	    public Sr_oper_activity_bonus_dayMO(string connectionString, int commandTimeout) : base(connectionString, commandTimeout) { }
		...
		public override int Add(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_); 
		}
		public override async Task<int> AddAsync(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null, bool useIgnore_ = false)
		{
			RepairAddData(item, useIgnore_, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_); 
		}
	    private void RepairAddData(Sr_oper_activity_bonus_dayEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		public int AddByBatch(IEnumerable<Sr_oper_activity_bonus_dayEO> items, int batchCount, TransactionManager tm_ = null)
		{
			var ret = 0;
	    ...
	    public async Task<int> AddByBatchAsync(IEnumerable<Sr_oper_activity_bonus_dayEO> items, int batchCount, TransactionManager tm_ = null)
	    {
	        var ret = 0;
	        foreach (var sql in BuildAddBatchSql(items, batchCount))
	        {
	    ...
	    private IEnumerable<string> BuildAddBatchSql(IEnumerable<Sr_oper_activity_bonus_dayEO> items, int batchCount)
		{
			var count = 0;
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Remove(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null)
		{
			return RemoveByPK(item.DayID, item.ActivityCode, tm_);
		}
		public async Task<int> RemoveAsync(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutAsync(Sr_oper_activity_bonus_dayEO item, TransactionManager tm_ = null)
		{
			RepairPutData(item, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutData(Sr_oper_activity_bonus_dayEO item, out string sql_, out List<MySqlParameter> paras_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int Put(IEnumerable<Sr_oper_activity_bonus_dayEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public async Task<int> PutAsync(IEnumerable<Sr_oper_activity_bonus_dayEO> items, TransactionManager tm_ = null)
		{
			int ret = 0;
			foreach (var item in items)
			{
		...
		public bool Set(Sr_oper_activity_bonus_dayEO item, TransactionManager tm = null)
		{
			bool ret = true;
		...
		public async Task<bool> SetAsync(Sr_oper_activity_bonus_dayEO item, TransactionManager tm = null)
		{
			bool ret = true;
			if(GetByPK(item.DayID, item.ActivityCode) == null)
			{
		...
		/// <return></return>
		public Sr_oper_activity_bonus_dayEO GetByPK(DateTime dayID, string activityCode, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(dayID, activityCode, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
			return Database.ExecSqlSingle(sql_, paras_, tm_, Sr_oper_activity_bonus_dayEO.MapDataReader);
		}
		public async Task<Sr_oper_activity_bonus_dayEO> GetByPKAsync(DateTime dayID, string activityCode, TransactionManager tm_ = null, bool isForUpdate_ = false)
		{
			RepairGetByPKData(dayID, activityCode, out string sql_, out List<MySqlParameter> paras_, isForUpdate_);
			return await Database.ExecSqlSingleAsync(sql_, paras_, tm_, Sr_oper_activity_bonus_dayEO.MapDataReader);
		}
		...
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID)
		{
			return GetByDayID(dayID, 0, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, TransactionManager tm_)
		{
			return GetByDayID(dayID, 0, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, int top_)
		{
			return GetByDayID(dayID, top_, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, int top_, TransactionManager tm_)
		{
			return GetByDayID(dayID, top_, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, int top_, TransactionManager tm_)
		{
		...
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, string sort_)
		{
			return GetByDayID(dayID, 0, sort_, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, string sort_, TransactionManager tm_)
		{
			return GetByDayID(dayID, 0, sort_, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByDayID(DateTime dayID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`DayID` = @DayID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@DayID", dayID, MySqlDbType.Date));
			return Database.ExecSqlList(sql_, paras_, tm_, Sr_oper_activity_bonus_dayEO.MapDataReader);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByDayIDAsync(DateTime dayID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`DayID` = @DayID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@DayID", dayID, MySqlDbType.Date));
			return await Database.ExecSqlListAsync(sql_, paras_, tm_, Sr_oper_activity_bonus_dayEO.MapDataReader);
		}
		...
		/// /// <param name = "activityCode"></param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode)
		{
			return GetByActivityCode(activityCode, 0, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, TransactionManager tm_)
		{
			return GetByActivityCode(activityCode, 0, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, int top_)
		{
			return GetByActivityCode(activityCode, top_, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, int top_, TransactionManager tm_)
		{
			return GetByActivityCode(activityCode, top_, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, string sort_)
		{
			return GetByActivityCode(activityCode, 0, sort_, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, string sort_, TransactionManager tm_)
		{
			return GetByActivityCode(activityCode, 0, sort_, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByActivityCode(string activityCode, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByActivityCodeAsync(string activityCode, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`ActivityCode` = @ActivityCode", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@ActivityCode", activityCode, MySqlDbType.VarChar));
		...
		/// /// <param name = "operatorID"></param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, int top_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, int top_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, top_, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, string sort_)
		{
			return GetByOperatorID(operatorID, 0, sort_, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, string sort_, TransactionManager tm_)
		{
			return GetByOperatorID(operatorID, 0, sort_, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByOperatorID(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByOperatorIDAsync(string operatorID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`OperatorID` = @OperatorID", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@OperatorID", operatorID, MySqlDbType.VarChar));
		...
		/// /// <param name = "amount"></param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount)
		{
			return GetByAmount(amount, 0, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, TransactionManager tm_)
		{
			return GetByAmount(amount, 0, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, TransactionManager tm_)
		{
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, int top_)
		{
			return GetByAmount(amount, top_, string.Empty, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, int top_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, int top_, TransactionManager tm_)
		{
			return GetByAmount(amount, top_, string.Empty, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, int top_, TransactionManager tm_)
		{
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, string sort_)
		{
			return GetByAmount(amount, 0, sort_, null);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, string sort_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, string sort_, TransactionManager tm_)
		{
			return GetByAmount(amount, 0, sort_, tm_);
		}
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, string sort_, TransactionManager tm_)
		{
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sr_oper_activity_bonus_dayEO> GetByAmount(long amount, int top_, string sort_, TransactionManager tm_)
		{
		...
		public async Task<List<Sr_oper_activity_bonus_dayEO>> GetByAmountAsync(long amount, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL("`Amount` = @Amount", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			paras_.Add(Database.CreateInParameter("@Amount", amount, MySqlDbType.Int64));
